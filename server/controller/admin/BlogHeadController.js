...
const headModel  =  require("../../models/apis/admin/BlogHead");
...
const index = async (req, res) => {
    ...
    let data = await headModel.getListing(req, select, where);
    //let data = await headModel.getAll(where, select);
    if(data)
    {
        res.send({
            'status':true,
...
const add = async (req, res) => {
    ...
    if(!validatorRules.fails())
    {
        ...
        let resp = await headModel.create(data);
        if(resp)
        {
            res.send({
                'status':true,
...
const edit = async (req, res) => {
    ...
    if(!validatorRules.fails())
    {
        let resp = await headModel.modify(id, data);
        if(resp)
        {
            res.send({
                'status':true,
...
const remove = async (req, res) => {
    ...
    let resp = await headModel.remove(id);
...
const view = async (req, res) => {
    ...
    let resp = await headModel.get(id);
